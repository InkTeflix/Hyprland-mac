...
We highly recommend creating a new desktop session entry. This allows you to safely test these dotfiles without interfering with your current desktop environment configuration.
</details>
...
> [!NOTE]
> Please change the directory if the cloned locations differ, when creating manually.
